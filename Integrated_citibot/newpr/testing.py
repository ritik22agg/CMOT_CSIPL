...
def retrain():
    newDict1 = {'Complete', 'Failed', 'Request', 'General', 'Pending', 'Processing', 'Request'}
    newDict2 = {}
    newDict3 = {}
    ct = 0
    ...
    with open('emaildataset.csv', 'a') as f:
        out = csv.writer(f)
        for mail in mails.query.all():
            if mail.m_class in newDict1 or mail.m_class in newDict3:
                ct += 1
